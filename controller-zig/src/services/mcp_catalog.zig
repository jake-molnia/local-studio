...
const entries = [_]Entry{
    .{
        .id = "browser",
        .name = "Local Studio Browser",
        .description = "Session-isolated web navigation and page reading built into the Zig controller",
        .protocol_era = "modern",
        .transport = "builtin",
        .state = "stateful",
    ...
    .{
        .id = "github",
        .name = "GitHub",
        .description = "Official repositories, issues, pull requests, Actions, and code search tools",
        .protocol_era = "auto",
        .transport = "http",
    ...
    .{
        .id = "notion",
        .name = "Notion",
        .description = "Official workspace search, page, database, and content tools",
        .protocol_era = "auto",
        .transport = "http",
    ...
    .{
        .id = "cloudflare",
        .name = "Cloudflare",
        .description = "Official token-efficient search and execution across the Cloudflare API",
        .protocol_era = "modern",
        .transport = "http",
    ...
    .{
        .id = "railway",
        .name = "Railway",
        .description = "Official projects, services, deployments, variables, logs, and infrastructure tools",
        .protocol_era = "auto",
        .transport = "http",
    ...
    .{
        .id = "vercel",
        .name = "Vercel",
        .description = "Official project, deployment, log, domain, and documentation tools",
        .protocol_era = "auto",
        .transport = "http",
