...
The migration is not production-ready. Inference usage accounting, remaining SQLite table parity, runtime process supervision, installer and harness integration, desktop cutover, and shutdown with child processes still require live proof.
