...
export function AgentComposerStatusBar({
  ...
  return (
    <div className="relative z-20 mx-auto mt-1.5 flex w-full max-w-[calc(var(--composer-w)*0.9)] items-center gap-2 overflow-visible font-mono text-[length:var(--fs-xs)] text-(--dim) sm:mt-2 sm:w-[90%]">
