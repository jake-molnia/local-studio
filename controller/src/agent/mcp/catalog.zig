...
const entries = [_]Entry{
    ...
    .{
        ...
        .name = "GitHub",
        .company = "GitHub",
        .description = "Read and write repositories, review pull requests, post review and issue comments, manage releases, projects, packages, notifications, and Actions",
