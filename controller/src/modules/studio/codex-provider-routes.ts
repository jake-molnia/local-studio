...
export const registerCodexProviderRoutes = defineRoutes((app, context) =>
  mergeRoutes(
    app.get(
      "/studio/providers/openai-codex/status",
      documentRoute,
      effectHandler((ctx) =>
        Effect.tryPromise({
    ...
    app.post(
      "/studio/providers/openai-codex/login",
      documentRoute,
      effectHandler((ctx) =>
    ...
    app.get(
      "/studio/providers/openai-codex/login/:jobId",
      documentRoute,
      effectHandler((ctx) =>
        Effect.gen(function* () {
    ...
    app.post(
      "/studio/providers/openai-codex/login/:jobId/respond",
      documentRoute,
      effectHandler((ctx) =>
        Effect.gen(function* () {
    ...
    app.post(
      "/studio/providers/openai-codex/login/:jobId/cancel",
      documentRoute,
      effectHandler((ctx) =>
    ...
    app.post(
      "/studio/providers/openai-codex/logout",
      documentRoute,
      effectHandler((ctx) =>
        Effect.tryPromise({
